...
- **Old field:** `name`
  - **New component:** `marmot.group.profile.v1`

- **Old field:** `description`
  - **New component:** `marmot.group.profile.v1`

- **Old field:** `admin_pubkeys`
  - **New component:** `marmot.group.admin-policy.v1`

- **Old field:** `nostr_group_id`
  - **New component:** `marmot.transport.nostr.routing.v1`

- **Old field:** `relays`
  - **New component:** `marmot.transport.nostr.routing.v1`

- **Old field:** `image_hash`
  - **New component:** `marmot.group.blossom.image.v1`

- **Old field:** `image_key`
  - **New component:** `marmot.group.blossom.image.v1`

- **Old field:** `image_nonce`
  - **New component:** `marmot.group.blossom.image.v1`

- **Old field:** `image_upload_key`
  - **New component:** `marmot.group.blossom.image.v1`

- **Old field:** `disappearing_message_secs`
  - **New component:** `marmot.group.message-retention.v1`
