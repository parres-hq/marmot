...
This directory is experimental spec text. It is for Marmot protocol surfaces that a clean-room implementation would
need:
...
- group-state lifecycle, inbound processing, convergence, and retained history;
...
4. `state-machine/README.md`
5. `layout.md`
6. `app-components.md`
7. `app-components/README.md`
8. `transports/README.md`
...
- Feature docs own the user-visible flow and cross-reference the surfaces that implement it.
