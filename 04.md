...
**Current Version**: The specification is currently at version `mip04-v1`, which defines deterministic ChaCha20-Poly1305 AEAD encryption with keys derived from MLS exporter secrets. All `imeta` tags MUST include `v mip04-v1` to indicate this encryption version.
...
| `v` | Encryption version number (currently "mip04-v1") | Yes |
