...
file_key = HKDF-Expand(exporter_secret, "mip04-v1" || 0x00 || file_hash_bytes || 0x00 || mime_type_bytes || 0x00 || "key", 32)
nonce = HKDF-Expand(exporter_secret, "mip04-v1" || 0x00 || file_hash_bytes || 0x00 || mime_type_bytes || 0x00 || "nonce", 12)
```
