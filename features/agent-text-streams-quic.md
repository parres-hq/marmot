...
This final payload is the group history item. Clients may replace the live preview with this final message, keep both, or
use the final message to mark the preview as verified.
