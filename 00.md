...
The `mls_extensions` tag includes marmot_group_data (`0xf2ee`) and last_resort (`0x000a`) extensions which MUST be included. The `mls_proposals` tag includes self_remove (`0x000a`) which MUST be included.
