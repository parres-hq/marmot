...
- **`content`**: Serialized [`MLSMessage`](https://www.rfc-editor.org/rfc/rfc9420.html#section-6-4) encrypted with ChaCha20-Poly1305, base64-encoded as `base64(nonce || ciphertext)`
